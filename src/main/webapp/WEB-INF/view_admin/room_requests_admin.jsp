...
<div class="parent">
   ...
   <td><fmt:message key="id"/></td>
               ...
               <td><fmt:message key="dateIn"/></td>
               <td><fmt:message key="dateOut"/></td>
    </thead>
     <% if(errors == null){%>
    <c:forEach items="${roomRequests}" var="r">
    		<tr>
    			<td>${r.id}</td>
    			<td>${r.roomTypeId}</td>
    			<td>${r.dateIn}</td>
    	...
    	<%}else{%>
            	<tr class="error"><fmt:message key="noRoomRequests"/></tr>
            	<%}%>
    	<tfoot>
             <td><fmt:message key="id"/></td>
                           <td><fmt:message key="roomTypeId"/></td>
    ...
    <div class="child2">
       <div class="prevNextContainer">
              ...
              int p = (Integer)request.getAttribute("page")-1;%>href="room_requests_admin?page=<%=p%>" class="btn"
              ...
              <span style = "font-size:1.3em; color:white;font-weight:bold;" class="pages" id="page">${page}</span>
                     ...
                     <% }
                      %> href="room_requests_admin?page=<%=p1%>" style = "font-size:1.5em; color:white;font-weight:bold;"
